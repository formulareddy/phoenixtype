  ...
  return (
    <div class="page-full">
      ...
      <div class="page-full-content" style="max-width:48rem;margin:0 auto;padding:2rem 1rem">
        <p style="color:var(--sub);margin-bottom:2rem">These terms of service were last updated on June 19, 2022.</p>

        <h1 style="font-size:2rem;color:var(--main);margin:3rem 0 1rem">Agreement</h1>
        <p>
        ...
        <h1 style="font-size:2rem;color:var(--main);margin:3rem 0 1rem">Limitations</h1>
        <p>
        ...
        <p>
          Phoenixtype reserves the right to remove or disable any account or any
        ...
        <ol style="padding-left:2rem">
          ...
          <li>is degrading to others on the basis of gender, race, class, ethnicity, national origin, religion, sexual preference, orientation, or identity, disability, or other classification, or otherwise represents or condones content that: is hate speech, discriminating, threatening, or pornographic; incites violence; or contains nudity or graphic or gratuitous violence;</li>
          <li>violates any person's right to privacy or publicity, or otherwise solicits, collects, or publishes data, including personal information and login information, about other Users without consent or for unlawful purposes in violation of any applicable international, federal, state, or local law, statute, ordinance, or regulation; or</li>
        ...
        <ol style="padding-left:2rem">
          <li>harass, abuse, threaten, or incite violence towards any individual or group, including other Users and Phoenixtype contributors;</li>
          <li>use our servers for any form of excessive automated bulk activity (e.g., spamming), or rely on any other form of unsolicited advertising or solicitation through our servers or Services;</li>
          ...
          <li>falsely impersonate any person or entity, including any of our contributors, misrepresent your identity or the site's purpose, or falsely associate yourself with Phoenixtype;</li>
          ...
          <li>access or attempt to access any service on the Services by any means other than as permitted in this Agreement, or operating the Services on any computers or accounts which you do not have permission to operate;</li>
        ...
        <p>
          ...
          content anywhere on the Services that violates any laws. Phoenixtype
        ...
        <h1 style="font-size:2rem;color:var(--main);margin:3rem 0 1rem">Privacy Policy</h1>
        <p>
          If you use our Services, you must abide by our Privacy Policy. You
          acknowledge that you have read our
          <a href="https://monkeytype.com/privacy-policy" target="_blank" rel="noreferrer noopener" style="color:var(--main)">Privacy Policy</a>
        ...
        <h1 style="font-size:2rem;color:var(--main);margin:3rem 0 1rem">Limitations on Automated Use</h1>
        <p>You shouldn't use bots or access our Services in malicious or prohibited ways. While accessing or using the Services, you may not:</p>
        <ol style="padding-left:2rem">
          <li>use bots, hacks, or cheats while using our site;</li>
          <li>create manual requests to Phoenixtype servers;</li>
          <li>tamper with or use non-public areas of the Services, or the computer or delivery systems of Phoenixtype and/or its service providers;</li>
          <li>probe, scan, or test any system or network (particularly for vulnerabilities), or otherwise attempt to breach or circumvent any security or authentication measures, or search or attempt to access or search the Services by any means (automated or otherwise) other than through our currently available, published interfaces that are provided by Phoenixtype (and only pursuant to those terms and conditions), unless you have been specifically allowed to do so in a separate agreement with Phoenixtype, Inc., or unless specifically permitted by Phoenixtype, Inc.'s robots.txt file or other robot exclusion mechanisms;</li>
          ...
          <li>use the Services to send altered, deceptive, or false source-identifying information, including, without limitation, by forging TCP-IP packet headers or e-mail headers; or</li>
        ...
        <h1 style="font-size:2rem;color:var(--main);margin:3rem 0 1rem">Links</h1>
        <p>Phoenixtype is not responsible for the contents of any linked sites. The use of any linked website is at the user's own risk.</p>

        <h1 style="font-size:2rem;color:var(--main);margin:3rem 0 1rem">Changes</h1>
        <p>Phoenixtype may revise these Terms of Service for its Website at any time without prior notice. By using this Website, you are agreeing to be bound by the current version of these Terms of Service.</p>

        <h1 style="font-size:2rem;color:var(--main);margin:3rem 0 1rem">Disclaimer</h1>
        <p>
          ...
          SOLELY THE RESPONSIBILITY OF THE RESPECTIVE USER PROVIDING THAT CONTENT.
          NO ADVICE OR INFORMATION, WHETHER ORAL OR WRITTEN, OBTAINED FROM
          MONKEYTYPE OR THROUGH THE SERVICES, WILL CREATE ANY WARRANTY NOT
          EXPRESSLY MADE HEREIN. MONKEYTYPE DOES NOT WARRANT, ENDORSE, GUARANTEE,
          OR ASSUME RESPONSIBILITY FOR ANY USER CONTENT ON THE SERVICES OR ANY
          HYPERLINKED WEBSITE OR THIRD-PARTY SERVICE, AND MONKEYTYPE WILL NOT BE
          A PARTY TO OR IN ANY WAY BE RESPONSIBLE FOR TRANSACTIONS BETWEEN YOU
          AND THIRD PARTIES. IF APPLICABLE LAW DOES NOT ALLOW THE EXCLUSION OF
        ...
        <h1 style="font-size:2rem;color:var(--main);margin:3rem 0 1rem">Contact</h1>
        <p>
          If you have any questions about Phoenixtype's privacy policy, the data
          we hold on you, or you would like to exercise one of your data
          protection rights, please do not hesitate to contact us.
        </p>
        <p>Email: <a href="mailto:contact@monkeytype.com" style="color:var(--main)">contact@monkeytype.com</a></p>
        <p>Discord: @miodec</p>
        <p style="margin-top:2rem;font-size:0.85rem;color:var(--sub)">
          Terms based on <a href="https://glitch.com/legal" target="_blank" rel="noreferrer noopener" style="color:var(--main)">Glitch terms</a>.
        </p>
      </div>
    </div>
  );
